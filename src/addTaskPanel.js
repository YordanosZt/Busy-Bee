...
const addTaskPriorityMenu = document.querySelector(".add-task__priority-menu");
const addTaskDueDateInput = document.querySelector(".add-task__due-date-input");
...
function createTagBox({ title, desc, priority, tagList, dueDate }) {
    return `
        <div class="task-box" data-priority-level="${priority}">
            ...
            <div class="task-box__footer">
                ...
                />
                <img
                    class="task-box__tag-btn task-box__icon"
                    src="/tag-icon.png"
                    alt="tag icon"
                />
                <img
